  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12" style={{ maxWidth: '1440px' }}>
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">{dict.legal.privacyPolicy.sections.useOfCookies.title}</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">{dict.legal.privacyPolicy.sections.contact.title}</h2>
          <p className="text-gray-700 leading-relaxed">{dict.legal.privacyPolicy.sections.contact.content}</p>
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            <p className="text-gray-700">
              <strong>{dict.legal.privacyPolicy.sections.contact.email}:</strong> contacto@delrio.dev
              <br />
        ...
        <section className="text-sm text-gray-600">
          <p>{dict.legal.privacyPolicy.sections.updates.content}</p>
        </section>
      </div>
    </div>
  );
