    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-12 p-6 bg-blue-50 rounded-lg">
        ...
        <div className="space-y-2 text-sm">
          <p>
            <strong>1. Dimensiones recomendadas:</strong> 400x400px (cuadrada)
          </p>
          <p>
            <strong>2. Formato:</strong> JPG o PNG
          </p>
          <p>
            <strong>3. Ubicación:</strong> <code>/public/profile-photo.jpg</code>
          </p>
          <p>
            <strong>4. Características:</strong>
          </p>
          ...
          <p className="mt-4">
            <strong>5. Después de subir la foto:</strong> Edita el generador para usar tu imagen real en lugar del emoji
          </p>
        </div>
      </div>
    </div>
