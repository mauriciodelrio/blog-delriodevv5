...
export default function BlogPostClient({
  ...
  const { contentToRender, imgs, postData, goBack } = useBlogActions(
    frontmatter,
    content,
    spanishFrontmatter,
    spanishContent,
  ...
  useEffect(() => {
    ...
    const hasTrackedInSession = typeof window !== 'undefined' && sessionStorage.getItem(sessionKey) === 'true';
        ...
        <div className="flex flex-wrap justify-center desktop:mx-4 mobile:mx-0 w-full max-w-[1280px] mobile:px-2 tablet:px-4 desktop:px-12">
          <div className="flex flex-wrap flex-row w-auto max-w-[1280px] rounded-lg shadow-md">
            ...
            >
              ...
              <div className="absolute inset-0 transition-all duration-1000" style={overlayStyle}></div>
              ...
              <div className="relative flex items-center justify-center desktop:p-8 mobile:p-4 w-full">
                <div className="text-center">
                  ...
                  <h1
                    className={`w-full desktop:text-6xl mobile:text-3xl tablet:text-5xl font-black desktop:py-4 text-center bg-gradient-to-r bg-clip-text text-transparent drop-shadow-2xl leading-tight ${gradientStyle ? `from-white via-blue-100 to-purple-100` : `${textColors.titleGradient || 'from-white via-blue-100 to-purple-100'}`}`}
                  >
                    {title}
                  </h1>
              ...
              <Markdown
                ...
                components={{
                  ...
                  code({ node, inline, className, children, ...props }) {
                    ...
                    return !inline && match ? (
                      <div
                        className="mobile:w-[calc(100vw-2rem)] mobile:max-w-[calc(100vw-2rem)] mobile:overflow-x-auto 
